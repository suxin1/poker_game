...
use crate::{asset_tracking::ResourceHandles, screens::ScreenState, theme::prelude::*};
...
pub(super) fn plugin(app: &mut App) {
    ...
    app.add_systems(
        Update,
        enter_gameplay_screen.run_if(in_state(ScreenState::Loading).and(all_assets_loaded)),
    );
}
...
fn enter_gameplay_screen(mut next_screen: ResMut<NextState<ScreenState>>) {
