...
fn start_credits_music(mut commands: Commands, credits_music: Res<CreditsAssets>, audio_settings: Res<AudioSettings>) {
    commands.spawn((
        Name::new("Credits Music"),
        StateScoped(Menu::Credits),
        music_audio(&audio_settings, credits_music.music.clone()),
    ));
}
